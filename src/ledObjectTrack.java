...
public class ledObjectTrack{  
	...
	private static void trackGreen() throws AWTException{
		...
		Scalar hsv_min = new Scalar(5, 150, 100, 0);  
	     Scalar hsv_max = new Scalar(15, 250, 150, 0);  
	     Scalar hsv_min2 = new Scalar(5, 150, 100, 0);  
	     Scalar hsv_max2 = new Scalar(15, 250, 150, 0);
		...
		{  
			...
			{  
				...
				{  
					...
					else if(inFrame == true && contours.size() != 0)
					{
						inFrame = true;
					}
					else if(inFrame == false && contours.size() != 0)
					{
						numHalfRev++;
						inFrame = true;
					}
					System.out.println(numHalfRev);
